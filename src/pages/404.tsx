...
const NotFoundPage: React.FC<PageProps> = () => {
  return (
    <section className="bg-[#051405] dark:bg-gray-900 ">
      <div className="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
        <div className="wf-ull lg:w-1/2">
          <p className="text-sm font-medium text-lime-500">404 error</p>
          <h1 className="mt-3 text-2xl font-semibold text-slate-100 md:text-3xl">
            Page not found
          </h1>
          ...
          <div className="flex items-center mt-6 gap-x-3">
            <Link
              to="/"
              className="w-1/2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 shrink-0 sm:w-auto rounded-xl bg-gradient-to-tr from-green-700 to-lime-500 py-2 px-4"
            >
              Take me home
            </Link>
          </div>
        ...
        <div className="relative w-full mt-12 lg:w-1/2 lg:mt-0">
          ...
          >
            ...
            <circle
              ...
              stroke-width="2"
            />
            <circle cx="21" cy="102" r="20" stroke="#84cc16" stroke-width="2" />
            <circle
              cx="141"
              cy="102"
              r="20"
              ...
              stroke-width="2"
            />
            <circle cx="193" cy="82" r="20" stroke="#84cc16" stroke-width="2" />
            <circle cx="313" cy="82" r="20" stroke="#84cc16" stroke-width="2" />
            <circle cx="253" cy="22" r="20" stroke="#84cc16" stroke-width="2" />
            <circle
              cx="253"
              cy="142"
              r="20"
            ...
            <path
              ...
              stroke-width="2"
            />
            <circle cx="453" cy="22" r="20" stroke="#84cc16" stroke-width="2" />
            <circle
              cx="453"
              cy="142"
              r="20"
            ...
            <path
              ...
              stroke-width="2"
            />
            <circle cx="253" cy="82" r="80" stroke="#84cc16" stroke-width="2" />
            <circle cx="253" cy="82" r="40" stroke="#84cc16" stroke-width="2" />
            <line
              x1="8.74228e-08"
              y1="1"
              x2="513"
