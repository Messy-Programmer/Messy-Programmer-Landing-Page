...
>) {
  ...
  const highlight =
    "radial-gradient(75% 181.15942028985506% at 50% 50%, #4dbe4d 0%, rgba(77, 190, 77, 0) 100%)";
  ...
  return (
    <Tag
      ...
      className={cn(
        "relative flex rounded-full content-center bg-[#051405] hover:bg-black/10 transition duration-500 dark:bg-white/20 items-center flex-col flex-nowrap gap-10 h-min justify-center overflow-visible p-px decoration-clone w-fit",
        containerClassName
      )}
      {...props}
    >
      ...
      />
      <div className="bg-[#051405] absolute z-1 flex-none inset-[2px] rounded-[100px]" />
    </Tag>
  );
}
